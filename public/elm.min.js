...
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		{inter: false, limit: 18, modeText: 'SPOILER ALERT!', rangeMax: 21, spoilerMode: true, spoilerVal: 60, viewMode: false},
		...
		switch (msg.$) {
			...
			case 'ToggleView':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{rangeMax: 21, viewMode: !model.viewMode}),
					$author$project$Main$focusIncrementButton);
			default:
				return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
		}
	});
var $author$project$Main$DecrementRange = {$: 'DecrementRange'};
var $author$project$Main$IncrementRange = {$: 'IncrementRange'};
var $author$project$Main$ToggleShowInterim = {$: 'ToggleShowInterim'};
var $author$project$Main$ToggleView = {$: 'ToggleView'};
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Events$onClick($author$project$Main$DecrementRange)
						]),
					_List_fromArray(
						[
					...
					_List_fromArray(
						[
							...
							$elm$html$Html$Events$onClick($author$project$Main$IncrementRange)
						]),
					_List_fromArray(
						[
					...
					_List_fromArray(
						[
							$elm$html$Html$Events$onClick($author$project$Main$ToggleView)
						]),
					_List_fromArray(
						[
					...
					_List_fromArray(
						[
							...
							A2(
								$elm$core$String$join,
								', ',
								$author$project$Main$squareList(model.rangeMax)))
						]))
				]));
	} else {
		var numberList = A2(
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Events$onClick($author$project$Main$ToggleShowInterim),

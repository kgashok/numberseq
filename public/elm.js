		...
		switch (msg) {
			...
			case 1:
				return _Utils_Tuple2(
					...
					$elm$core$Platform$Cmd$none);
			case 2:
				var mtext = (model.E === 'hide hints') ? 'show hints' : 'hide hints';
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{p: !model.p, E: mtext}),
...
var $author$project$Main$renderDiff = F2(
	function (lst, inter) {
		var offset = inter ? 3 : 1;
		var highIndex = $elm$core$List$length(lst) - offset;
		var items = A2(
			...
			lst);
		return A2($elm$html$Html$ul, _List_Nil, items);
	});
...
var $author$project$Main$toSquareString = A2(
	$elm$core$Basics$composeR,
	$elm$core$Maybe$map(
		function (n) {
...
var $author$project$Main$squareDigit = A2(
	$elm$core$Basics$composeR,
		...
		A2(
			...
			$elm$core$List$filterMap(
				A2(
					...
					A2($elm$core$Basics$composeR, $elm$core$String$toInt, $author$project$Main$toSquareString))),
			A2(
				$elm$core$Basics$composeR,
